...
- 25 importable subpackages, 713 tracked Python files total under infrastructure/ — a real inventory anyone can `git ls-files` themselves, not a claimed abstraction.
- The largest single subpackage, core, holds 118 files — still a minority of the whole, not a monolith wearing a modular label.
