...
slide-by-slide narrative at three lengths;
\breaktt{manuscript/deck\_tokens.yaml} supplies the facts.
...
\textbf{Facts, not fabrication.} Every numeric claim in
\breaktt{deck\_tokens.yaml} about the pitch subject
...
in the content has no matching key in
\breaktt{manuscript/deck\_tokens.yaml} --- mirroring
\texttt{template\_madlib}'s
...
repository state (\breaktt{manuscript/deck\_content\_*.yaml},
\breaktt{manuscript/deck\_tokens.yaml}, and the live facts
