"""Shared path/logging bootstrap for the pitch-deck analysis scripts.
...
def project_root() -> Path:
    """The template_pitch_deck project directory."""
...
def get_logger(name: str) -> Any:
    ...
    try:
        from infrastructure.core.logging.utils import get_logger as _infra_logger
